    ...
    <main className={styles.portfolio}>
      ...
      <section className={styles.portfolio__wrap}>
        ...
        >
          ...
          YouTube, Facebook, Instagram, as well as flyers, posters, and logos.
          It&apos;s been an exciting journey creating a diverse range of content
          that caters to these different platforms.
        </p>
        ...
        >
          ...
          able to showcase my creativity across various mediums when working
          with the &ldquo;Uflawless Medical Grade Skincare&ldquo; Team.
        </p>
        ...
        <p
          className={`${styles.portfolio__heading} ${styles.portfolio__firstP}`}
        >
          Each platform and medium comes with it&apos;s own unique requirements,
          and I enjoy tailoring my work to suit the specific needs and
          preferences of each one. The People from the &ldquo;Farm Picked for
          You&ldquo; and I were very pleased with the results developed for the
          Logo, Package, Flyers, Posters, User Interface, and Social Media
          Assets.
        </p>
        ...
        >
          ...
          portfolio. If you&apos;re inclined too see it, the world of paper and
          ink is very real.
        </p>
        ...
        >
          ...
          from the &ldquo;Conti Realty Group&ldquo; benefit a lot from the
